...
save.addEventListener('click', function(){
    ...
    save.style.background = ' linear-gradient(180deg, #02766bab 41.15%, #a3ebb1ab 87.5%)'
    save.style.color = '#ffffff'
  
    setTimeout(()=>{
        save.style.background = '#linear-gradient(180deg, #21b6a8ab 0%, #21b6a859 95.83%)'
        save.style.color = '#000000'
    }, 1000); 
    
    alrtUser('All List Items Saved','#f0f1a0' )
...
delLists.addEventListener('click', function(){
    instBtn.style.background = '#2f889d'
    instBtn.style.color = '#ffffff'
  
    setTimeout(()=>{
        instBtn.style.background = 'linear-gradient(180deg, #21b6a8ab 0%, #21b6a859 95.83%)'
        ...
        lst.addEventListener('click', function(e){
            ...
            if(!idsPressed.includes(listID)){
                ...
                for(let i = 0; i <lst.parentElement.children.length; i++){
                    lst.parentElement.children[i].style.background = ' linear-gradient(180deg, #02766bab 41.15%, #a3ebb1ab 87.5%)'
...
plus.addEventListener('click', function(){
    ...
    //saving the status of addlist display style
